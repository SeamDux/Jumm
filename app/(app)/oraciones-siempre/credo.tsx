...
export default function CredoScreen() {
  return (
    <OracionSiempreLayout title="Credo">
      <PrayerSectionTitle>Símbolo de los Apóstoles</PrayerSectionTitle>
      <PrayerParagraph>
        ...
        los cielos y está sentado a la derecha de Dios, Padre todopoderoso. Desde allí ha de venir
        a juzgar a vivos y muertos. Creo en el Espíritu Santo, la santa Iglesia católica, la
        comunión de los santos, el perdón de los pecados, la resurrección de la carne y la vida
        eterna. Amén.
      </PrayerParagraph>

      <PrayerSectionTitle>Credo Nicenoconstantinopolitano</PrayerSectionTitle>
      <PrayerParagraph>
      ...
      <PrayerParagraph>
        ...
        siglos, Dios de Dios, Luz de Luz, Dios verdadero de Dios verdadero, engendrado, no hecho,
        consustancial al Padre; por él todas las cosas fueron hechas.
      </PrayerParagraph>
      <PrayerParagraph>
        ...
        Escrituras, y subió a los cielos, y está sentado a la derecha del Padre; y de nuevo vendrá
